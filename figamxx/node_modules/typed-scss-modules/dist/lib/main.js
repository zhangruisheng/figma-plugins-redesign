...
exports.main = function (pattern, options) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                core_1.setAlertsLogLevel(options.logLevel);
                ...
                if (fs_1.default.existsSync(pattern) && fs_1.default.lstatSync(pattern).isDirectory()) {
                    ...
                    pattern = slash_1.default(path_1.default.resolve(pattern, "**/*.scss"));
                }
