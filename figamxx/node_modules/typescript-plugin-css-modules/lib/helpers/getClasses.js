    ...
    try {
        ...
        if (options.customRenderer) {
            ...
            transformedCss_1 = sass_1.default
                ...
                data: css.replace(/(@import ['"])~(?!\/)/gm, '$1'), indentedSyntax: fileType === "sass" /* sass */, includePaths: __spreadArrays([filePath, 'node_modules'], (includePaths || [])), importer: [aliasImporter] }, sassOptions))
                .css.toString();
        }
