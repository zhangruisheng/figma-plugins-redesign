import { computeSiblingNodes, formatErrorMessage, formatSuccessMessage, updateNodesSortOrder } from '@create-figma-plugin/utilities';
...
export function mainFactory(options) {
    ...
    return function () {
        ...
        figma.closePlugin(didChange === true
